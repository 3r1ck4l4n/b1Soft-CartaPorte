...
<body>
    <div id="Fuera">
        ...
        <div id="Fuera">
            ...
            <form style="border: solid gray 1px; text-align: left; width: 450px; border-radius: 5%;" id="Fuera">

                <div id = "Dentro" style="text-align: left; width: 350px; justify-items: end;" >
                    <br>
                 <span style="text-align: center;" id = "Fuera">Por favor ingresa los datos solicitados </br><br/><br/></span>
